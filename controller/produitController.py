...
class ScraperPageProduit:
    ...
    def ScrapProduit(self):
        ...
        path_fichier_json = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'Data.json')
        produits_data = [] 
        ...
        with open(path_fichier_csv, mode='w', newline='', encoding='utf-8') as file:
            ...
            try:
                ...
                for index, produit in enumerate(list_produits):
                    ...
                    try:
                        ...
                        for img_src in img_srcs:
                            ...
                            if img_src_url and img_src_url not in produits_vus:
                                ...
                                self.afficher_texte_couleur(f"Image URL: \033[96m{img_src_url}\033[0m", 'bleu')
                    ...
                    try:
                        ...
                        for description in descriptions:
                            ...
                            if description_text and description_text not in produits_vus:
                                ...
                                self.afficher_texte_couleur(f"Description: \033[96m{description_text}\033[0m\n",'bleu')
                    ...
                    try:
                        ...
                        for prix in prixs:
                            ...
                            if prix_text and prix_text not in produits_vus:
                                ...
                                self.afficher_texte_couleur(f"Prix : \033[96m{prix_text}\033[0m\n",'bleu')
                    ...
                    time.sleep(0.5)
                    with open(path_fichier_json, 'w', encoding='utf-8') as json_file:
                        json.dump(produits_data, json_file, ensure_ascii=False, indent=4)
            except Exception as e:
