        ...
        try:
            ...
            for produit in list_produits:
                ...
                try:
                    ...
                    prix = produit.find_element(By.CSS_SELECTOR, "div.ads-main-search-component-price div.search-card-e-price-main").text
                    if prix:
                        print(f"Prix : {prix}")
                    # for description in descriptions:
                    #     description_text = description.text
...
if __name__ == "__main__":
    # Initialisation
    scraper = ScraperPageProduit(url='https://www.alibaba.com/trade/search?spm=a2700.product_home_newuser.header.258.2ce267af8P5l3X&categoryId=201896803&SearchText=5G+smartphone&indexArea=product_en&fsb=y&productId=1601165310579')
    scraper.open_page()
