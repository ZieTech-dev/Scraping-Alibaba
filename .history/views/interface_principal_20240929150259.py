...
class InterfacePrincipale:
    ...
    def afficher_categories(self,categories):
        """Affiche les catégories avec des index pour permettre la sélection."""
    ...
    def afficher_sous_categories(self,sous_categories):
        """Affiche les sous-catégories avec des index pour permettre la sélection."""
        print("Sous-catégories disponibles :")
        ...
        # while True:
            ...
            if choix == 1:
                ...
                for nom_categorie, details in DATA.items():
                    nom_categorie = CategorieModel(nom_categorie, details['url'])
                    
                    for nom_sous_categorie, sous_details in details['SousCategorie'].items():
                        nom_sous_categorie = SousCategorieModel(nom_sous_categorie, sous_details['url'])
                        nom_categorie.ajouter_sous_categorie(nom_sous_categorie)
                    
                    # Créer le dossier pour la catégorie et ses sous-catégories
                    nom_categorie.creer_dossier(chemin_data ,nom_sous_categorie)

                print("Les dossiers ont été créés avec succès dans le dossier Data.")
...
# categories_data = {
#     'Packaging & Printing': {
#         'url': 'https://www.alibaba.com/Packaging-Printing_p23',
#         'SousCategorie': {
...
#         'url': 'https://www.alibaba.com/Jewelry-Eyewear-Watches-Accessories_p36',
#         'SousCategorie': {
