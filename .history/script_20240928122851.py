    ...
    def ScrapProduit(self):
        try:
            ...
            for produit in list_produits:
                ...
                try:
                    imgs_src = produit.find_element(By.CSS_SELECTOR, "div.search-card-e-slider__wrapper img")
                ...
                # Description 
                try:
                    descriptions = produit.find_element(By.CSS_SELECTOR, "h2.search-card-e-title span")
